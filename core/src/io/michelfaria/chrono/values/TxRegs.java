...
public enum TxRegs {
    ...
    TxRegs(String regionName, int columns, int rows) {
        this(regionName, columns, rows, 0);
    }

    TxRegs(String regionName, int columns, int rows, float speed) {
        this(regionName, columns, rows, speed, null);
    }

    TxRegs(String regionName, int columns, int rows, float speed, int[] assembly) {
